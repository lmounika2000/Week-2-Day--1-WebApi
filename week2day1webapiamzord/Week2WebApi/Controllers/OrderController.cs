...
namespace Week2WebApi.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Orderstb>>> GetAllOrdersByCountryName(string name)
        {
            try
            {
                ...
                var resp = await _ordertbBusiness.GetAllOrdersByCountryName(name);
        ...
        public async Task<ActionResult<double>> SumOfOrdersCostByCountryName(string name)
        {
            try
            {
                ...
                var resp = await _ordertbBusiness.SumOfOrdersCostByCountryName(name);
